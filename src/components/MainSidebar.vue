  ...
  <div class="sidebar2">
    ...
    <div class="sidebar3">
      ...
      <div class="home-links3" :class="{ active: $route.path === '/main_payment' }">
        ...
        <router-link to="/main_payment" class="tjm1">{{ $t('payment') }}</router-link>
      </div>
      <div class="home-links4" :class="{ active: $route.path === '/clients' }">
        <img class="contract-edit-icon1" loading="lazy" alt="" :src="contractEdit" />
        <router-link to="/clients" class="contract1">{{ $t('clients') }}</router-link>
      </div>
      <div class="home-links4" :class="{ active: $route.path === '/main_debt' }">
        <img class="contract-edit-icon1" loading="lazy" alt="" :src="contractEdit" />
        <router-link to="/main_debt" class="contract1">{{ $t('Debt') }}</router-link>
      </div>
      ...
      <div style="padding-bottom:2rem;">
        <div class="home-links4" :class="{ active: $route.path === '/mainpage' }">
        <img class="contract-edit-icon1" loading="lazy" alt="" :src="contractEdit" />
      ...
      <div class="home-links4" :class="{ active: $route.path === '/settings' }">
        <img class="contract-edit-icon1" loading="lazy" alt="" :src="contractEdit" />
        <router-link to="/settings" class="contract1">{{ $t('Settings') }}</router-link>
      </div>
      </div>
    </div>
  </div>
...
.logo1 {
  ...
  padding-top: 1rem;
  /* padding: var(--padding-5xs) var(--padding-25xl) var(--padding-5xs) 0px; */
  gap: var(--gap-sm);
}
.divider {
  align-self: stretch;
  height: 1px;
  position: relative;
  border-top: 1px dashed var(--grayscale-300);
...
.home-links {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-3xs) var(--padding-119xl) var(--padding-3xs) var(--padding-3xs);
  gap: var(--gap-3xs);
}
.account-balance-wallet-icon1 {
  height: 20px;
  width: 20px;
  position: relative;
}
...
.home-links1 {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-5xs) var(--padding-130xl) var(--padding-5xs) var(--padding-4xs);
  gap: var(--gap-3xs);
}
.credit-card-clock-icon1 {
  height: 20px;
  width: 20px;
  position: relative;
}
...
.home-links2 {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-3xs) var(--padding-161xl) var(--padding-3xs) var(--padding-3xs);
  gap: var(--gap-3xs);
}
.location-city-icon1 {
  height: 20px;
...
.home-links3 {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-3xs) var(--padding-165xl) var(--padding-3xs) var(--padding-3xs);
  gap: var(--gap-3xs);
}
.contract-edit-icon1 {
  height: 20px;
...
.home-links4 {
  ...
  align-items: center;
  justify-content: flex-start;
  padding: var(--padding-3xs) var(--padding-131xl) var(--padding-3xs) var(--padding-3xs);
  gap: var(--gap-3xs);
}
.sidebar3 {
  display: flex;
  ...
  text-decoration: none;
  /* font-family: var(--heading-h6-semibold); */
}
.sidebar2 {
