    ...
    <div class="bg-[#F4F6F6]  h-full w-full" >
        <div  class="flex w-full min-h-screen">
            ...
            <div class="rounded-[14px] bg-white p-[16px] my-[8px] w-full " >
                <div class="w-full">
                <div class="flex items-center justify-between pb-[16px] w-full">
                ...
                <div class="flex gap-[64px] pt-[14px] w-full" >
                    <div>
            ...
            <div class="w-full">
                <div class=" flex gap-[16px] w-full">
                    <div class="bg-[#F4F6F6] p-[16px] rounded-[12px] flex-grow  w-full">
        ...
        <transition
            ...
            >
                <div v-show="isFilterOpen"  class="fixed inset-0 bg-[#F4F6F6] flex justify-end w-[312px] rounded-[8px] p-[8px] m-[8px] h-full">
                    <div class="min-h-screen">
                        <div class="flex justify-between bg-[#FFFFFF]  p-[12px] my-[6px] rounded-[6px] ">
                        ...
                        <div class=" mb-[6px] bg-[#FFFFFF] rounded-[6px] p-[12px] h-full">
        ...
        <!-- Table Settings -->
        <div v-show="isSettingsOpen" class="fixed inset-0 bg-black bg-opacity-50 " @click.self="closeSettings"></div>
         <transition 
            name="slide"
         ...
         >
                    <div v-show="isSettingsOpen"  class=" fixed inset-0  flex justify-end" @click.self="closeSettings">
                        <div class="bg-[#F4F6F6] w-[312px]   rounded-[8px] p-[8px] m-[8px] ">
                            <div class="w-full h-full pb-5">
                                ...
                                <div class="bg-[#FFFFFF] rounded-[6px] p-[12px] h-full">
                                    <div class="flex items-center justify-between">
         ...
         >
                ...
                <div v-show="isMessageOpen" class="fixed inset-0 flex justify-end m-[8px]" @click.self="closeMessage">
                    <div class="bg-[#F4F6F6] p-[6px] w-[539px] m-[8px] rounded-[8px] ">
                        <div class="w-full h-full pb-[20px]">
                            ...
                            <div class="bg-[#FFFFFF] p-[12px] mt-[6px] rounded-[6px] flex flex-col h-full">
                                <div>
