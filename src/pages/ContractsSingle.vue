<template>
    <div class="bg-[#F4F6F6] h-full">
        <div class="flex w-full min-h-screen">
                ...
                <div class="flex justify-between">
                    <ul class="py-[16px] flex gap-[20px]"> 
                        ...
                        <li class="flex gap-[10px] items-center text-[14px] cursor-pointer" @click="openArchive" style="font-family: Geist; font-weight: 500; color: #000000;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.83333 9.3335H11.6667M6 12.0002H11.6667M14 4.66683V11.3335C14 13.3335 13 14.6668 10.6667 14.6668H5.33333C3 14.6668 2 13.3335 2 11.3335V4.66683C2 2.66683 3 1.3335 5.33333 1.3335H10.6667C13 1.3335 14 2.66683 14 4.66683ZM10.3333 1.3335V6.57349C10.3333 6.86682 9.98665 7.01348 9.77332 6.82015L8.22668 5.39351C8.10002 5.27351 7.89998 5.27351 7.77332 5.39351L6.22668 6.82015C6.01335 7.01348 5.66667 6.86682 5.66667 6.57349V1.3335H10.3333Z" stroke="#72908D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Archive
                        </li>
                        <div style="border: 1px solid #EDF1F1"></div>
                        ...
                        <li @click="openContract" class=" cursor-pointer flex gap-[10px] items-center text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.99992 5.3335V8.66683M7.99626 10.6668H8.00224M7.99992 14.6668C11.6666 14.6668 14.6666 11.6668 14.6666 8.00016C14.6666 4.3335 11.6666 1.3335 7.99992 1.3335C4.33325 1.3335 1.33325 4.3335 1.33325 8.00016C1.33325 11.6668 4.33325 14.6668 7.99992 14.6668Z" stroke="#72908D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                    ...
                    <div class="flex items-center gap-[6px] pr-[10px] cursor-pointer" @click="openCancellation">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.6667 6.66683V10.0002C14.6667 13.3335 13.3334 14.6668 10 14.6668H6.00004C2.66671 14.6668 1.33337 13.3335 1.33337 10.0002V6.00016C1.33337 2.66683 2.66671 1.3335 6.00004 1.3335H9.33337M14.6667 6.66683H12C10 6.66683 9.33337 6.00016 9.33337 4.00016V1.3335M14.6667 6.66683L9.33337 1.3335" stroke="#DB4F00" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #DB4F00;">Cancel</p>
                    </div>
                </div>
                    
                    <div class="bg-[#EDF1F1] p-[6px] rounded-[8px] flex w-full">
                        <div class="w-full">
                            <div class="flex gap-[6px] w-full pb-[6px]">
                                <div class="bg-[#FFFFFF] py-[20px] px-[16px] rounded-[6px] flex flex-col items-start gap-[12px] w-full" style="border: 1px solid var(--Line-Container-Line, #EDF1F1)">
                            ...
                            <div class="mt-[6px] p-[16px] rounded-[6px] bg-[#FFFFFF] " style="border: 1px solid #EDF1F1">
                                <div class="flex gap-[6px]">
                                    <button @click="selectTab('history')" :class="[' py-[6px] px-[12px] rounded-[6px] text-[14px] cursor-pointer' , selectedTab === 'history' ? 'bg-[#E5EBFF]' : 'bg-[#F4F6F6]']" :style="{fontFamily: 'Geist' , fontWeight:'600' , color: selectedTab === 'history' ? '#0037FF' : '#72908D'}">Payment history</button>
                                    <button @click="selectTab('schedule')" :class="[' py-[6px] px-[12px] rounded-[6px] text-[14px] cursor-pointer' , selectedTab === 'schedule' ? 'bg-[#E5EBFF]' : 'bg-[#F4F6F6]']" :style="{fontFamily: 'Geist' , fontWeight:'600' , color: selectedTab === 'schedule' ? '#0037FF' : '#72908D'}">Payment schedule</button>
                                ...
                                <div class="">
                                    <table class="paymenr-table mt-[16px]" v-if="selectedTab == 'history'">
                                        ...
                                        <tbody class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">
                                            <tr>
                                                <td>184</td>
                                                <td style="font-weight: 600;">XUDAYBERDIYEV ILXOMJON ISMATULLOYEVICH</td>
                                                <td>09.08.2024 
                                                    13:37</td>
                                                <td>2,219,100,000 
                                                    UZS</td>
                                                ...
                                                <td @click="openPayment" class="cursor-pointer">
                                                    ...
                                                    <path d="M10.7998 0C5.2898 0 0.799805 4.49 0.799805 10C0.799805 15.51 5.2898 20 10.7998 20C16.3098 20 20.7998 15.51 20.7998 10C20.7998 4.49 16.3098 0 10.7998 0ZM10.0498 6C10.0498 5.59 10.3898 5.25 10.7998 5.25C11.2098 5.25 11.5498 5.59 11.5498 6V11C11.5498 11.41 11.2098 11.75 10.7998 11.75C10.3898 11.75 10.0498 11.41 10.0498 11V6ZM11.7198 14.38C11.6698 14.51 11.5998 14.61 11.5098 14.71C11.4098 14.8 11.2998 14.87 11.1798 14.92C11.0598 14.97 10.9298 15 10.7998 15C10.6698 15 10.5398 14.97 10.4198 14.92C10.2998 14.87 10.1898 14.8 10.0898 14.71C9.9998 14.61 9.9298 14.51 9.8798 14.38C9.8298 14.26 9.7998 14.13 9.7998 14C9.7998 13.87 9.8298 13.74 9.8798 13.62C9.9298 13.5 9.9998 13.39 10.0898 13.29C10.1898 13.2 10.2998 13.13 10.4198 13.08C10.6598 12.98 10.9398 12.98 11.1798 13.08C11.2998 13.13 11.4098 13.2 11.5098 13.29C11.5998 13.39 11.6698 13.5 11.7198 13.62C11.7698 13.74 11.7998 13.87 11.7998 14C11.7998 14.13 11.7698 14.26 11.7198 14.38Z" fill="#95ACAA"/>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9.7998 11V17M9.7998 17L11.7998 15M9.7998 17L7.7998 15M22.7998 10V15C22.7998 20 20.7998 22 15.7998 22H9.7998C4.7998 22 2.7998 20 2.7998 15V9C2.7998 4 4.7998 2 9.7998 2H14.7998M22.7998 10H18.7998C15.7998 10 14.7998 9 14.7998 6V2M22.7998 10L14.7998 2" stroke="#335FFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18.7998 4.98C15.4698 4.65 12.1198 4.48 8.7798 4.48C6.7998 4.48 4.8198 4.58 2.8398 4.78L0.799805 4.98M6.2998 3.97L6.5198 2.66C6.6798 1.71 6.7998 1 8.4898 1H11.1098C12.7998 1 12.9298 1.75 13.0798 2.67L13.2998 3.97M16.6498 8.14L15.9998 18.21C15.8898 19.78 15.7998 21 13.0098 21H6.5898C3.7998 21 3.7098 19.78 3.5998 18.21L2.9498 8.14M8.1298 15.5H11.4598M7.2998 11.5H12.2998" stroke="#DB4F00" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">
                                            <tr>
                                                ...
                                                <td>Card</td>
                                                <td>
                                                    <svg @click="openPayment" class="cursor-pointer" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M10.7998 0C5.2898 0 0.799805 4.49 0.799805 10C0.799805 15.51 5.2898 20 10.7998 20C16.3098 20 20.7998 15.51 20.7998 10C20.7998 4.49 16.3098 0 10.7998 0ZM10.0498 6C10.0498 5.59 10.3898 5.25 10.7998 5.25C11.2098 5.25 11.5498 5.59 11.5498 6V11C11.5498 11.41 11.2098 11.75 10.7998 11.75C10.3898 11.75 10.0498 11.41 10.0498 11V6ZM11.7198 14.38C11.6698 14.51 11.5998 14.61 11.5098 14.71C11.4098 14.8 11.2998 14.87 11.1798 14.92C11.0598 14.97 10.9298 15 10.7998 15C10.6698 15 10.5398 14.97 10.4198 14.92C10.2998 14.87 10.1898 14.8 10.0898 14.71C9.9998 14.61 9.9298 14.51 9.8798 14.38C9.8298 14.26 9.7998 14.13 9.7998 14C9.7998 13.87 9.8298 13.74 9.8798 13.62C9.9298 13.5 9.9998 13.39 10.0898 13.29C10.1898 13.2 10.2998 13.13 10.4198 13.08C10.6598 12.98 10.9398 12.98 11.1798 13.08C11.2998 13.13 11.4098 13.2 11.5098 13.29C11.5998 13.39 11.6698 13.5 11.7198 13.62C11.7698 13.74 11.7998 13.87 11.7998 14C11.7998 14.13 11.7698 14.26 11.7198 14.38Z" fill="#95ACAA"/>
                                                    </svg>
                                                </td>
                                                <td>
                                ...
                                <div>
                                    <table class="schedule-table mt-[16px] w-[570px]" v-if="selectedTab === 'schedule'">
                                        ...
                                        <tbody v-if="amountPaid" >
                                            <tr v-for="(table, index) in fullPaymentSchedule" :key="index" class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">
                                                <td>{{ index + 1 }}</td>
                                                <td>{{ table.dateOfPayment }}</td>
                                                <td>{{ table.sumOfPayment }}</td>
                                                <td style="color: #00B252; font-weight: 600;">{{ table.paid }}</td>
                                            </tr>
                                        </tbody>
                                        <tbody >
                                            <tr v-for="(table, index) in paymentSchedule" :key="index" class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">
                                                <td>{{ index + 4 }}</td>
                                                <td>{{ table.dateOfPayment }}</td>
                                                <td>{{ table.sumOfPayment }}</td>
                                                <td style="color: #E27233;  font-weight: 600;">{{ table.paid }}</td>
                                            </tr>
                                        </tbody>
                                        <tbody v-if="amountPaid" >
                                            <tr v-for="(table, index) in fullPaymentSchedule" :key="index" class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">
                        ...
                        <div class="w-full">
                            <div class="bg-[#FFFFFF] px-[12px] pt-[12px] rounded-[6px] ml-[6px] h-fit" style="border: 1px solid var(--Line-Container-Line, #EDF1F1)">
                                <h2>Payments</h2>
                                ...
                                <div class="flex items-center gap-[12px] pt-[16px]">
                                    ...
                                    <path d="M17.464 18.64H20.008L24.104 30H21.928L20.984 27.312H16.488L15.544 30H13.368L17.464 18.64ZM20.376 25.536L18.744 20.736L17.096 25.536H20.376ZM25.2569 18.64H27.3049V25.312L30.8089 21.456H33.3369L29.9929 25.008L33.4489 30H31.1449L28.6489 26.224L27.3049 27.648V30H25.2569V18.64Z" fill="white"/>
                                    </svg>
                                    <div class="flex items-center  justify-between w-full">
                                        <div>
                                                <p>Akbarali Khasanov</p>
                                ...
                                <div class="flex items-start justify-between pb-[16px] pt-[12px]">
                                    <div >
                                        <div>
                                            ...
                                            <span class="text-[12px]"  style="font-family: Geist; font-weight: 500; color: #000000;">Samarqand viloyati</span>
                                        </div>
                                        <div class="pt-[12px]">
                                            <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908D;">City/district</p>
                                            <span class="text-[12px]"  style="font-family: Geist; font-weight: 500; color: #000000;">Tayloq tumani</span>
                                        </div>
                                    </div>
                                    <div class="max-w-[360px] w-full pl-[50px] ">
                                        <div>
                                            <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908D;">Address</p>
                                            <span class="text-[12px]"  style="font-family: Geist; font-weight: 500; color: #000000;">Tayloq tumani ГУЛБА ҚФЙ, ТАРАККИЁТ МФЙ, ЖАЛОИР ҚИШЛОҒИ, uy:Р/С</span>
                                        </div>
                                        <div class="pt-[12px]">
                                            <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908D;">Passport series, number</p>
                                            <span class="text-[12px]"  style="font-family: Geist; font-weight: 500; color: #000000;">AB 7867954</span>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-col gap-[5px]">
                                    <div class="flex items-center justify-between p-[6px] rounded-[6px] bg-[#EDF1F1]">
                                        ...
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">06.10.2017</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px]">
                                        <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4F7471">Date of birth</p>
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">07.04.1983</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px] rounded-[6px] bg-[#EDF1F1]">
                                    ...
                                    <div class="flex items-center justify-between p-[6px]">
                                        ...
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">SAMARQAND VILOYATI TAYLOQ TUMANI IIB</span>
                                    </div> 
                                    
                                </div>
                                <div class="flex items-center justify-center pb-[32px] pt-[16px] cursor-pointer">
                            ...
                            <div class="bg-[#FFFFFF]  p-[12px] rounded-[6px] mt-[6px] ml-[6px]">
                                ...
                                <div class="pt-[12px] flex flex-col gap-[5px]">
                                    <div class="flex items-center justify-between p-[6px] rounded-[6px] bg-[#EDF1F1]">
                                        ...
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">Hakimi Towers, 2</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px]">
                                        <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4F7471">Number of rooms</p>
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">2x</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px] rounded-[6px] bg-[#EDF1F1]">
                                        <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4F7471">Floor</p>
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">8</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px]">
                                        <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4F7471">Apartment number</p>
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">№41</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px] rounded-[6px] bg-[#EDF1F1]">
                                        <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4F7471">Total area</p>
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">67.9 m2</span>
                                    </div> 
                                    <div class="flex items-center justify-between p-[6px]">
                                        <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4F7471">Submission status</p>
                                        <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">Out of repair</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
            ...
            <div v-show="isImageOpen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start"></div>
            <transition name="popup">
                <div v-show="isImageOpen" class="fixed inset-0 flex justify-center items-center">
                    <div class="flex ">
            ...
            <div  v-if="isPaymentOPen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start"></div>
            <transition name="popup">
                    <div v-if="isPaymentOPen" class="fixed inset-0 flex justify-center items-center ">
                        <div class="bg-[#F4F6F6] p-[6px] rounded-[8px] w-[500px]">
                            <div class="bg-[#FFFFFF] p-[12px] rounded-[6px]" style="border: 1px solid var(--Line-Container-Line, #EDF1F1)">
                                ...
                                <div class="flex justify-between items-center pt-[12px]">
                                    ...
                                    <span class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">Xusnor Odilova</span>
                                </div>
                                <div class="divide pt-[12px]"></div>
                                <div class="flex justify-between items-center pt-[12px]">
                                    <p class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #72908D;">Date</p>
                                    <span class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000;">12.08.2024 18:25</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div v-if="isContractOpen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center"></div>
            <transition name="popup">
                <div v-if="isContractOpen" class=" fixed inset-0 flex justify-center items-center">
                    <div class="bg-[#F4F6F6] p-[6px] rounded-[8px] w-[500px]">
                        <div  class="bg-[#FFFFFF] p-[12px] rounded-[6px]" style="border: 1px solid var(--Line-Container-Line, #EDF1F1)">
                            <div class="flex justify-between items-center">
                            ...
                            <div class="flex justify-between items-center pt-[18px]">
                                    ...
                                    <span class="text-[14px] flex gap-[14px] items-center" style="font-family: Geist; font-weight: 500; color: #000000;">
                                        ...
                                        <path d="M16 12.4V15.4C16 19.4 14.4 21 10.4 21H6.6C2.6 21 1 19.4 1 15.4V11.6C1 7.6 2.6 6 6.6 6H9.6M16 12.4H12.8C10.4 12.4 9.6 11.6 9.6 9.2V6M16 12.4L9.6 6M10.6 1H14.6M6 4C6 2.34 7.34 1 9 1H11.62M21 7V13.19C21 14.74 19.74 16 18.19 16M21 7H18C15.75 7 15 6.25 15 4V1L21 7Z" stroke="#335FFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </span>
                                </div>
                                <div class="divide pt-[16px]"></div>
                                ...
                                <div class="flex justify-between items-center pt-[16px]">
                                    ...
                                    <svg @click="toggleInput" class="cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11 1.99976H9C4 1.99976 2 3.99976 2 8.99976V14.9998C2 19.9998 4 21.9998 9 21.9998H15C20 21.9998 22 19.9998 22 14.9998V12.9998M14.91 4.14976C15.58 6.53976 17.45 8.40976 19.85 9.08976M16.04 3.01976L8.16 10.8998C7.86 11.1998 7.56 11.7898 7.5 12.2198L7.07 15.2298C6.91 16.3198 7.68 17.0798 8.77 16.9298L11.78 16.4998C12.2 16.4398 12.79 16.1398 13.1 15.8398L20.98 7.95976C22.34 6.59976 22.98 5.01976 20.98 3.01976C18.98 1.01976 17.4 1.65976 16.04 3.01976Z" stroke="#335FFF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
            ...
            <div v-if="isCancelOpen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center"></div>
            <transition name="popup">
                <div v-if="isCancelOpen" class="fixed inset-0 flex justify-center items-center">
            ...
            <div v-if="isArchiveOpen" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center"></div>
            <transition name="popup">
                <div v-if="isArchiveOpen"  class="fixed inset-0 flex justify-center items-center" >
                    <div  class="bg-[#F4F6F6] p-[6px] m-[12px] rounded-[8px] w-[760px]">
                        <div  class="bg-[#FFFFFF] p-[12px] rounded-[6px]" style="border: 1px solid var(--Line-Container-Line, #EDF1F1)">
                            ...
                            <div class="flex mt-[12px] gap-[16px]">
                                <div v-for="(schedule, index) in paymentSchedules"
                                :key="index"
                                ...
                                style="border: 1px solid var(--Line-Container-Line, #EDF1F1)">
                                    ...
                                    <div>
                                        <div class="flex items-center justify-between ">
                                            ...
                                            <path d="M13.3307 9.1665H13.3382M9.99656 9.1665H10.004M6.66242 9.1665H6.6699M7.08366 15.8332H6.66699C3.33366 15.8332 1.66699 14.9998 1.66699 10.8332V6.6665C1.66699 3.33317 3.33366 1.6665 6.66699 1.6665H13.3337C16.667 1.6665 18.3337 3.33317 18.3337 6.6665V10.8332C18.3337 14.1665 16.667 15.8332 13.3337 15.8332H12.917C12.6587 15.8332 12.4087 15.9582 12.2503 16.1665L11.0003 17.8332C10.4503 18.5665 9.55033 18.5665 9.00033 17.8332L7.75033 16.1665C7.61699 15.9832 7.30866 15.8332 7.08366 15.8332Z" stroke="#335FFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </div>
            ...
            <div v-if="Payment" class="fixed inset-0 bg-black bg-opacity-50  flex justify-end"></div>
            <transition 
                name="slide"
                ...
                leave-to-class="translate-x-full">
                    <div v-if="Payment" class="fixed inset-0 flex justify-end">
    ...
    export default {
        ...
        data() {
            return {
                ...
                paymentSchedules : [
                    {
                        ...
                        createdDate : "29.03.2024 17:00",
                        cancelledDate : "29.03.2024 17:02",
                    },
                    {
                        title: "Payment schedule",
                        createdDate : "29.03.2024 17:00",
                ...
                paymentTable: [
                    {
                        paymentDate: "29.04.2024",
                        paymentSum: "11,515,000",
                        paidAmount: '---'
                    },
                    {
                        paymentDate: "29.04.2024",
                ...
                fullPaymentSchedule : [
                    {
                        dateOfPayment: "09.08.2024 ",
                        sumOfPayment : "8,000,000",
                        paid : "8,000,000",
                    },
                    {
                        dateOfPayment: "09.08.2024 ",
...
<style scoped>
    ...
    .paymenr-table th, .paymenr-table td{
        padding: 7px 7px;
    }
