    ...
    <div class="flex w-full min-h-screen">
      ...
      <div class="bg-[#FFFFFF] w-full rounded-[14px] my-[8px] mr-[6px] p-[16px]" style="border: 1px solid #edf1f1">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-[20px]" style="font-family: Geist; font-weight: 600; color: #000000">{{ client.last_name+' '+ client.first_name+' '+ client.middle_name}}</p>
            <p class="text-[10px] pt-[3px]" style="font-family: Geist; font-weight: 400; color: #b9c7c6">Clients > {{ client.last_name+' '+ client.first_name+' '+ client.middle_name}}</p>
          </div>
          ...
          <div class="bg-[#FFFFFF] p-[12px] rounded-[6px] w-full" style="border: 1px solid var(--Line-Container-Line, #edf1f1); box-shadow: 0px 1px 2px 0px #1823220d">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-[12px] pt-[16px]">
                ...
                <div>
                  <p class="text-[12px]" style="font-family: Geist; font-weight: 600; color: #000000">{{ client.last_name+' '+ client.first_name+' '+ client.middle_name}}</p>
                  <div class="flex items-center gap-[6px] pt-[6px]">
                    ...
                    <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908d">{{ client.phone_number }}</p>
                  </div>
                </div>
              </div>
            ...
            <div class="flex justify-between w-full">
              <div class="pt-[16px] w-full">
                <div>
                  ...
                  <span class="text-[12px]" style="font-family: Geist; font-weight: 600; color: #000000">NULL</span>
                </div>

                <div class="pt-[12px]">
                  <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908d">City/district</p>
                  <span class="text-[12px]" style="font-family: Geist; font-weight: 600; color: #000000">{{client.district}}</span>
                </div>
              </div>
              <div class="pt-[16px] w-full">
                <div>
                  <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908d">Residential address</p>
                  <span class="text-[12px]" style="font-family: Geist; font-weight: 600; color: #000000">{{ client.address }}</span>
                </div>
                <div class="pt-[12px]">
                  <p class="text-[10px]" style="font-family: Geist; font-weight: 500; color: #72908d">Passport series, number</p>
                  <span class="text-[12px]" style="font-family: Geist; font-weight: 600; color: #000000">{{ client.passport_series+' '+client.passport_number }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="pt-[16px]">
              <div class="flex justify-between p-[6px] bg-[#EDF1F1] rounded-[6px]">
                <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4f7471">Given date</p>
                <span class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000">{{ client.given_date }}</span>
              </div>
              <div class="flex justify-between p-[6px]">
                ...
                <span class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000">{{ client.birth_date }}</span>
              </div>
              <div class="flex justify-between p-[6px] bg-[#EDF1F1] rounded-[6px]">
                <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4f7471">Work place</p>
                <span class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000">{{ client.work_place }}</span>

              </div>
              <div class="flex justify-between p-[6px]">
                <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #4f7471">Given place</p>
                <span class="text-[14px]" style="font-family: Geist; font-weight: 500; color: #000000">{{ client.passport_place }}</span>
              </div>
            ...
            <div class="p-[12px] rounded-[12px] mt-[16px]" style="border: 1px solid #edf1f1">
              <div class="flex justify-between">
                ...
                <div class="flex items-center gap-[8px]">
                  <span class="text-[18px]" style="font-family: Geist; font-weight: 600; color: #335fff"><p>{{ client.contracts?.[0]?.contract_number }}</p>
                  </span>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M10.8333 9.1665L17.6666 2.33317M18.3333 5.6665V1.6665H14.3333M9.16663 1.6665H7.49996C3.33329 1.6665 1.66663 3.33317 1.66663 7.49984V12.4998C1.66663 16.6665 3.33329 18.3332 7.49996 18.3332H12.5C16.6666 18.3332 18.3333 16.6665 18.3333 12.4998V10.8332"
                      stroke="#335FFF"
                      stroke-width="1.5"
              ...
              <div class="pt-[20px] flex justify-between">
                ...
                <span class="text-[18px]" style="font-family: Geist; font-weight: 600; color: #000000">{{ client.contracts?.[0]?.total_payment_sum.toLocaleString() }} UZS</span>
              </div>
            </div>
            <div @click="openLead" class="cursor-pointer p-[16px] rounded-[12px] mt-[16px] flex justify-center items-center gap-[12px]" style="border: 1px solid #edf1f1">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M6.66669 9.99984H13.3334M10 13.3332V6.6665M10 18.3332C14.5834 18.3332 18.3334 14.5832 18.3334 9.99984C18.3334 5.4165 14.5834 1.6665 10 1.6665C5.41669 1.6665 1.66669 5.4165 1.66669 9.99984C1.66669 14.5832 5.41669 18.3332 10 18.3332Z"
                  stroke="#335FFF"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <div class="p-[12px] w-full" style="box-shadow: 2px -2px 12px 0px #0000001f">
              ...
              <div class="flex items-center justify-between pt-[48px]">
                ...
                <div class="flex gap-[12px]">
                  ...
                  <button
                    class="py-[8px] px-[28px] rounded-[8px] text-[16px]"
...
export default {
  ...
  methods: {
    ...
    async fetchTableData() {
      try {
        const response = await axios.get(`/accounts/clients/individual/${this.clientId}`);
