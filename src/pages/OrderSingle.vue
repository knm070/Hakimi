        ...
        <div class="flex w-full min-h-screen">
            ...
            <div class=" bg-[#FFFFFF] w-full rounded-[14px] my-[8px] mr-[6px] p-[16px] " style="border: 1px solid #EDF1F1">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-[20px]" style="font-family: Geist; font-weight: 600; color: #000000;">№ 49</p>
                        <p class="text-[10px]" style="font-family: Geist; font-weight: 400; color: #B9C7C6;"> Order > № 49</p>
                    </div>
                        ...
                        <div class="bg-[#FFFFFF] px-[12px] pt-[12px] pb-[32px] w-full rounded-[6px]" style="border: 1px solid var(--Line-Container-Line, #EDF1F1);box-shadow: 0px 1px 2px 0px #1823220D;">
                            <div class="flex justify-between">
                                ...
                                <div class="flex items-center gap-[4px]">
                                    ...
                                    <span class="text-[20px]" style="font-family: Geist;font-weight: 600; color: #0037FF;">#47</span>
                                </div>
                                <div class="py-[3px] px-[12px] bg-[#6C6C6C] rounded-full flex items-center gap-[10px]" >
                                    <svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2.772 4.508C2.4 4.508 2.064 4.424 1.764 4.256C1.476 4.088 1.242 3.86 1.062 3.572C0.882 3.272 0.792 2.942 0.792 2.582C0.792 2.018 0.978 1.556 1.35 1.196C1.734 0.836 2.208 0.656 2.772 0.656C3.348 0.656 3.822 0.836 4.194 1.196C4.566 1.556 4.752 2.018 4.752 2.582C4.752 2.954 4.662 3.284 4.482 3.572C4.314 3.86 4.08 4.088 3.78 4.256C3.492 4.424 3.156 4.508 2.772 4.508Z" fill="white"/>
                                    </svg>
                                    <p class="text-[14px]" style="font-family: Geist; font-weight: 400; color: #FFFFFF;">home.CANCELED</p>
                                </div>
                            </div>
                                ...
                                <div class=" pt-[20px]">
                                    <div class=" flex items-center">
                                        <div class="w-full">
                                            ...
                                            <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">Sulaymonova Nodira</span>
                                        </div>
                                        <div class="w-full">
                                            <p class="text-[14px] " style="font-family: Geist; font-weight: 500; color: #72908D;">Responsible employee</p>
                                            <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">Xusnor Odilova</span>
                                        </div>
                                    </div>
                                </div>
                                <div class=" pt-[20px]">
                                    <div class=" flex items-center">
                                        <div class="w-full">
                                            ...
                                            <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">Hakimi Towers, 3</span>
                                        </div>
                                        <div class="w-full">
                                    ...
                                    <div class=" pt-[20px]">
                                        <div class=" flex items-center">
                                            <div class="w-full">
                                                ...
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">26</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px] " style="font-family: Geist; font-weight: 500; color: #72908D;">Floor</p>
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">5</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" pt-[20px]">
                                        <div class=" flex items-center">
                                            <div class="w-full">
                                                ...
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">3</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px] " style="font-family: Geist; font-weight: 500; color: #72908D;">Area (m²)</p>
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">98.7</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" pt-[20px]">
                                        <div class=" flex items-center">
                                            <div class="w-full">
                                                ...
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">UZS</span>
                                            </div>
                                            <div class="w-full">
                                    ...
                                    <div class=" pt-[20px]">
                                        <div class=" flex items-center">
                                            <div class="w-full">
                                                ...
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">3 day</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px] " style="font-family: Geist; font-weight: 500; color: #72908D;">Order date</p>
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">29.06.2024 11:39</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" pt-[20px]">
                                        <div class=" flex items-center">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <span class="text-[14px]" style="font-family: Geist; font-weight: 600; color: #000000;">740 250 000 UZS</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" pt-[20px]">
