<template>
    <div class="bg-[#F4F6F6] h-full">
        <div class="flex w-full min-h-screen">
            <MainSidebar image="../image@2x.png" home="../home.svg"
                accountBalanceWallet="../account-balance-wallet1.svg" creditCardClock="../credit-card-clock.svg"
                locationCity="../location-city.svg" contractEdit="../contract-edit.svg"
                homeLinksTextDecoration="unset" />
            <div class="bg-[#FFFFFF] w-full rounded-[14px] my-[8px] mr-[6px] p-[16px]"
                style="border: 1px solid #edf1f1">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-[20px]" style="font-family: Geist; font-weight: 600; color: #000000">№ {{ orderId
                            }}</p>
                        <p class="text-[10px]" style="font-family: Geist; font-weight: 400; color: #b9c7c6">Order > № {{
                            orderId }}</p>
                    </div>
                    <div class="flex gap-[24px]">
                        <svg @click="openMessage" class="cursor-pointer" width="24" height="25" viewBox="0 0 24 25"
                ...
                <div class="bg-[#F4F6F6] mt-[16px] p-[6px] rounded-[8px] min-h-screen">
                    <div class="flex gap-[6px]">
                        <div class="bg-[#FFFFFF] px-[12px] pt-[12px] pb-[32px] w-full rounded-[6px]"
                            style="border: 1px solid var(--Line-Container-Line, #edf1f1); box-shadow: 0px 1px 2px 0px #1823220d">
                            <div class="flex justify-between">
                                <div class="flex items-center gap-[4px]">
                                    <p class="text-[20px]" style="font-family: Geist; font-weight: 600; color: #3f5d5a">
                                        Order</p>
                                    <span class="text-[20px]"
                                        style="font-family: Geist; font-weight: 600; color: #0037ff">#{{ orderId
                                        }}</span>
                                </div>
                                <button :class="{
                            ...
                            <div class="pt-[24px]">
                                            ...
                                            <div class="flex items-center gap-[6px] pt-[6px]">
                                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#72908D" stroke-width="1.5" stroke-miterlimit="10" />
                                                </svg>
                                ...
                                <div class="pt-[20px]">
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            <p class="text-[14px]"
                                                style="font-family: Geist; font-weight: 500; color: #72908d">Client</p>
                                        ...
                                        <div class="w-full">
                                            <p class="text-[14px]"
                                                style="font-family: Geist; font-weight: 500; color: #72908d">Responsible
                                                employee</p>
                                            <span class="text-[14px]"
                                                style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                data.responsible }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-[20px]">
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            <p class="text-[14px]"
                                                style="font-family: Geist; font-weight: 500; color: #72908d">Residential
                                                complex</p>
                                            <span class="text-[14px]"
                                                style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                data.apartment.project_name }}</span>
                                        </div>
                                        <div class="w-full">
                                            <p class="text-[14px]"
                                                style="font-family: Geist; font-weight: 500; color: #72908d">Address</p>
                                            <span class="text-[14px]"
                                                style="font-family: Geist; font-weight: 600; color: #000000">NULL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-[20px]">
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            <p class="text-[14px]"
                                                style="font-family: Geist; font-weight: 500; color: #72908d">Client
                                                phone number</p>
                                            <span class="text-[14px]"
                                                style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                data.client_info.phone_number }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="pt-[20px]">
                                    ...
                                    <div class="pt-[20px]">
                                        <div class="flex items-center">
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">House
                                                    number</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.apartment.house_number }}</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Floor
                                                </p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.apartment.floor_number }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-[20px]">
                                        <div class="flex items-center">
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Number
                                                    of rooms</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.apartment.room_numbers }}</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Area
                                                    (m²)</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.apartment.area }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-[20px]">
                                        <div class="flex items-center">
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">
                                                    Unrepaired price</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.apartment.unrepaired_price.toLocaleString() }} UZS</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">
                                                ...
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.apartment.repaired_price.toLocaleString() }} UZS</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pt-[20px]">
                                    ...
                                    <div class="pt-[20px]">
                                        <div class="flex items-center">
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Order
                                                    period (day)</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{
                                                    data.period }} day</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Order
                                                    date</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">{{ new
                                                    Date(data.created_at).toLocaleString() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-[20px]">
                                        <div class="flex items-center">
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Payment
                                                    status</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">Payment
                                                    is non-refundable</span>
                                            </div>
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Agreed
                                                    amount</p>
                                                <span class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000"> {{
                                                    data.agreed_amount }}UZS</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pt-[20px]">
                                        <div class="flex items-center">
                                            <div class="w-full">
                                                <p class="text-[14px]"
                                                    style="font-family: Geist; font-weight: 500; color: #72908d">Date of
                                                    order cancellation</p>
                                                <span class="text-[14px] flex items-center gap-[12px]"
                                                    style="font-family: Geist; font-weight: 600; color: #000000">
                        ...
                        <div class="bg-[#FFFFFF] p-[12px] w-full rounded-[6px]"
                            style="border: 1px solid var(--Line-Container-Line, #edf1f1); box-shadow: 0px 1px 2px 0px #1823220d">
                            <h2 class="text-[20px]" style="font-family: Geist; font-weight: 600; color: #3f5d5a">
                                Payments</h2>
                            <div class="divide pt-[16px]"></div>

                            <div class="w-full h-full flex items-center justify-center">
                                <p class="text-[20px]" style="font-family: Geist; font-weight: 600; color: #72908d">This
